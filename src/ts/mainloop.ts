 ...
 *
 * A TypeScript port of the IceCreamYou's wonderful MainLoop.js - https://github.com/IceCreamYou/MainLoop.js
 */
export let MainLoop = (function(root) {
    // The amount of time (in milliseconds) to simulate each time update()
    // runs. See `MainLoop.setSimulationTimestep()` for details.
    let simulationTimestep: number = 1000 / 60,
	...
	return class MainLoop {
		 ...
		 */
		public static getSimulationTimestep(): number {
		 ...
		 *   {@link #setUpdate update}().
		 */
		public static setSimulationTimestep(timestep: number) {
		 ...
		 */
		public static getMaxAllowedFPS(): number {
		 ...
		 * @chainable
		 */
		public static setMaxAllowedFPS(fps: number) {
